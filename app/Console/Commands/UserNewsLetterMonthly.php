...
class UserNewsLetterMonthly extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'newslettermonthly:user';
     ...
     * @var string
     */
    protected $description = 'Send news letter to user monthly';
