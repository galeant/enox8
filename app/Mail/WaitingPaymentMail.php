...
class WaitingPaymentMail extends Mailable
{
    ...
    public function build()
    {
        ...
        $title = "Menunggu Pembayaran Transfer Manual untuk pembayaran PYM/".date('Ymd')."/".integerToRoman(date('m'))."/".integerToRoman(date('y'))."/".$data['all']['id']."";
        ...
        return $this->view('emails.waiting_payment', compact(
            'title',
            'tanggal',
            'total_payment',
            'payment_time_limit',
